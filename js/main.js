...
/*Manage the massage that a new player has joined*/
...
/*If someone left the room then animate out all their account */
var dom_elements = $('.socket_'+payload.socket_id);
...
/*Manage the massage that a player has left*/
...
$(function(){
	...
	console.log('*** client Log Message: \'join_roon\' payload: '+JSON.stringify(payload));
